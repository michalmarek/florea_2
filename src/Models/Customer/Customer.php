...
class Customer
{
    public function __construct(
        ...
        public readonly ?DateTime $registeredAt, // datum
        public readonly ?DateTime $lastLoginAt,  // prihlasen
     ...
     *
     * Internal method - used only by CustomerRepository for authentication.
     *
